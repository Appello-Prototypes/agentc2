...
| K-14 | TeeOn test credentials expired/invalidated   | LOW      | Open      | Cycle 5     |             | Test credentials (Oaks4247/Prometrix#123) no longer accepted by TeeOn. Both HTTP and Playwright login fail identically. Likely locked/expired after repeated failed attempts during K-12 debugging. Need fresh test credentials to validate full booking flow. |
