                            ...
                            {dailyStats.map((day) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 text-right">
                                        {day._sum.totalRuns?.toLocaleString()}
                                    </td>
                                    <td className="px-4 py-2 text-right text-green-500">
                                        {day._sum.successfulRuns?.toLocaleString()}
                                    </td>
                                    <td className="px-4 py-2 text-right text-red-500">
                                        {day._sum.failedRuns?.toLocaleString()}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                            ...
                            {dailyCosts.map((day) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2 text-right font-medium">
                                        ${day._sum.totalCostUsd?.toFixed(2)}
                                    </td>
                                    <td className="text-muted-foreground px-4 py-2 text-right">
                                        {day._sum.totalInputTokens?.toLocaleString()}
                                    </td>
                                    <td className="text-muted-foreground px-4 py-2 text-right">
                                        {day._sum.totalOutputTokens?.toLocaleString()}
                                    </td>
                                </tr>
                            ))}
                        </tbody>
                            ...
                            {recentErrors.map((run) => (
                                <tr key={run.id} className="border-border border-b last:border-0">
                                    ...
                                    <td className="px-4 py-2 text-xs text-red-500">
                                        {(run.errorMessage || "Unknown error").substring(0, 80)}
                                    </td>
