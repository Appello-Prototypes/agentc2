...
secondaryKeywords: ["document upload", "RAG ingestion", "document chunking", "document embedding", "document versioning"]
pageType: "how-to"
...
<Callout type="tip">
Use **semantic chunking** for documents with clear structure (markdown, HTML). Use **fixed-size** for unstructured text. Use **recursive** for very long documents.
</Callout>
