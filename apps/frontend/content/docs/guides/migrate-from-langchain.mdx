...
relatedSlugs: ["agents/overview", "agents/creating-agents", "workflows/overview", "networks/overview", "agents/tools"]
pageType: "tutorial"
...
<Callout type="info">
    This guide covers migration from LangChain and LangGraph. AgentC2 provides similar capabilities with a database-driven, production-focused architecture.
</Callout>
