...
relatedSlugs: ["integrations/overview", "integrations/building-custom"]
pageType: "reference"
...
- **[Building Custom Integrations](/docs/integrations/building-custom)** — Create custom integration providers
