...
<Callout type="warning">
    **Memory limits**: Large builds may require increased memory. Set `NODE_OPTIONS="--max-old-space-size=24576"` for 24GB limit.
</Callout>
...
<Callout type="tip">
    **DNS provider**: Configure DNS provider credentials in Caddyfile for automatic certificate issuance. Cloudflare, Digital Ocean, and other providers are supported.
</Callout>
