...
export const partnerNetworksData: UseCaseData = {
    ...
    heroTitle:
        "AI agents that collaborate across organizational boundaries — securely",
    heroDescription:
    ...
    agentExamples: [
        ...
        },
        {
            ...
            channels: ["Web", "Slack"],
            guardrails: [
                "Client-side approval for writes",
                "Session time limits",
            ],
        },
        {
            ...
            guardrails: [
                "Budget cap per campaign",
                "PII masking on audience data",
            ],
        },
    ],
    integrations: [
