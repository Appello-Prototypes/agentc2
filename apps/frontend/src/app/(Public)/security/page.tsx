                ...
                <div className="max-w-none space-y-10">
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            email, calendar, CRM, project management, file storage, and
                            communication services. Because our platform handles sensitive
                            integration credentials and accesses third-party services on your
                            behalf, security is foundational to how we build and operate the system.
                            This policy describes the specific technical measures we implement to
                            protect your data.
                        </p>
                    </section>
                    ...
                    <section>
                            ...
                            <table className="w-full text-sm">
                                <tbody className="divide-border/40 divide-y">
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            256 bits (32 bytes), derived from a hex-encoded
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            GCM authentication tag stored alongside ciphertext,
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            Encrypted payload stored as a JSON object with version
                                            tag, base64-encoded IV, authentication tag, and
                                            ciphertext
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <p className="text-muted-foreground mt-3 leading-relaxed">
                            ...
                            callback) and decrypted only at the moment of use (e.g., when making an
                            API call to a third-party service). The encryption key is stored as a
                            server-side environment variable and is never exposed to client-side
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            All OAuth2 authorization flows that support it use PKCE (Proof Key for
                            Code Exchange, RFC 7636) to prevent authorization code interception
                            attacks. This applies to our Microsoft and Dropbox integrations, which
                            generate a random code verifier and SHA-256 code challenge for every
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            buffer) and on 401 responses. If a refresh permanently fails (e.g., the
                            user revoked consent), the integration connection is automatically
                            marked inactive and no further API calls are attempted until the user
                            re-authenticates.
                        </p>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            User authentication is handled by Better Auth, which provides
                            session-based authentication with secure, HttpOnly, SameSite cookies.
                            Sessions are stored server-side in the database. We do not use
                            client-side JWTs for authentication.
                        </p>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            Incoming Slack webhook events are verified using the Slack signing
                            secret (HMAC-SHA256) to ensure requests originate from Slack and have
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            using HTTPS/TLS. In production, TLS termination is handled by Caddy with
                            automatic certificate management (via Let&apos;s Encrypt). All API calls
                            to third-party services (Google, Microsoft, HubSpot, Slack, etc.) are
                            made over HTTPS.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="text-muted-foreground ml-5 list-disc space-y-3 text-sm leading-relaxed">
                            <li>
                                ...
                                hosted on Supabase with connection-level encryption. The database is
                                not directly accessible from the public internet.
                            </li>
                            <li>
                                <strong className="text-foreground">Application Server:</strong>{" "}
                                Hosted on Digital Ocean with SSH key-based access only (no password
                            ...
                            <li>
                                ...
                                handles TLS termination, request routing, and HTTPS enforcement.
                                HTTP requests are automatically redirected to HTTPS.
                            </li>
                            <li>
                                <strong className="text-foreground">Environment Variables:</strong>{" "}
                                All secrets (API keys, encryption keys, OAuth credentials) are
                                stored as environment variables on the server, never committed to
                                source control or exposed to client-side code.
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            AgentC2 implements multi-tenant architecture with organization and
                            workspace isolation:
                        </p>
                        <ul className="text-muted-foreground mt-2 ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            <li>
                                Each organization has its own agents, integrations, workflows, and
                                data — fully isolated from other organizations
                            </li>
                            <li>
                                Integration credentials are scoped to organizations. One
                                organization cannot access another&apos;s credentials or connected
                                services
                            </li>
                            <li>
                                Role-based access controls within organizations govern who can
                                configure agents, manage integrations, and view analytics
                            </li>
                            <li>
                                Agent budget controls and guardrail policies limit per-agent spend
                                and enforce content safety rules
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="text-muted-foreground mt-2 ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            ...
                            <li>
                                Agent run execution, including tool calls and model interactions
                            </li>
                        </ul>
                        <p className="text-muted-foreground mt-2 leading-relaxed">
                            Audit logs include timestamps, actor identity, action type, and entity
                            details. These logs are available to organization administrators through
                    ...
                    <section>
                        ...
                        <ul className="text-muted-foreground mt-2 ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            ...
                            <li>
                                Integration data is accessed only when agents actively execute
                                tasks, not continuously or in bulk
                            </li>
                            <li>
                                When you disconnect an integration, stored OAuth tokens are deleted
                                and all API access ceases immediately
                            </li>
                            <li>
                                ...
                                rather than full write access, reflecting actual feature
                                requirements
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="text-muted-foreground mt-2 ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            ...
                            <li>
                                ...
                                including details of what data was affected and what steps we are
                                taking
                            </li>
                            <li>
                            ...
                            <li>
                                Relevant authorities will be notified as required by applicable law
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground mt-2 leading-relaxed">
                            We take all security reports seriously and will acknowledge receipt
                            within 48 hours.
                        </p>
                    </section>
