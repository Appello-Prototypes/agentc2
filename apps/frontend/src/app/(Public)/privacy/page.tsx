                ...
                <div className="max-w-none space-y-10">
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            by Appello Software Pty Ltd (ABN 62 641 990 128), a company registered
                            in Queensland, Australia. We operate the AgentC2 AI agent platform at{" "}
                            ...
                            processing it, how we use and protect it, your rights regarding your
                            data, and how to contact us. We are committed to transparency and to
                            protecting your privacy in accordance with the Australian Privacy Act
                            1988, the EU General Data Protection Regulation (GDPR), the California
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            personal data processed through the AgentC2 platform. For questions
                            about data processing or to exercise your rights, contact us at{" "}
                            <a
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            CRM records, post messages, and more. The platform supports multiple AI
                            model providers (OpenAI, Anthropic), workflow automation, voice agents,
                            knowledge base management, and multi-channel deployment (Slack, email,
                            voice, web, API).
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            provider, we receive your basic profile information (name, email
                            address, profile photo) as provided by the identity provider.
                        </p>
                        ...
                        <div className="bg-muted/30 border-primary/20 mb-6 rounded-xl border px-5 py-4">
                            ...
                            <ul className="text-muted-foreground mt-3 ml-5 list-disc space-y-2 text-sm leading-relaxed">
                                <li>
                                    ...
                                    the AgentC2 platform features you explicitly enable
                                </li>
                                ...
                                <li>
                                    ...
                                    purposes such as investigating abuse; (c) to comply with
                                    applicable law; or (d) when the data is aggregated and
                                    anonymized for internal operations
                                </li>
                                <li>
                                    We do not transfer or sell Google user data to third parties
                                    except as necessary to provide the Service (e.g., sending data
                                    to AI model providers for agent responses) or as required by law
                                </li>
                            </ul>
                        </div>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            operating system, device type, referring URL, pages viewed, and
                            timestamps. This data is used for security monitoring, performance
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground mb-3 leading-relaxed">
                            ...
                            or other jurisdictions that require a legal basis for processing
                                ...
                                <tbody className="divide-border/40 divide-y">
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            Processing necessary to provide the Service you
                                            requested (account management, agent execution,
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            Security monitoring, fraud prevention, service
                                            improvement, analytics, and troubleshooting, balanced
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            Compliance with applicable laws, regulations, or valid
                                            legal processes
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <section>
                        ...
                        <ul className="text-muted-foreground ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            ...
                            <li>
                                ...
                                for advertising, ad targeting, ad profiling, or data brokering
                            </li>
                            <li>
                    ...
                    <section>
                        ...
                        <ul className="text-muted-foreground ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            <li>
                                ...
                                agreements. We use API endpoints that do not use your data for model
                                training.
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                agents execute tasks via their APIs, as configured by you.
                            </li>
                            <li>
                                <strong className="text-foreground">
                                    Infrastructure Providers
                                </strong>{" "}
                                (Supabase for database hosting, Digital Ocean for application
                                hosting): Your data is stored on infrastructure operated by these
                                providers, subject to their security practices and data processing
                                agreements.
                            </li>
                        </ul>
                        <p className="text-muted-foreground mt-3 leading-relaxed">
                            We do not share your data with any other third parties for their own
                            marketing or commercial purposes. We may disclose your data if required
                            by law, legal process, or government request, or to protect the rights,
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            Supabase, which may be located outside your country of residence. AI
                            model providers (OpenAI, Anthropic) process data in the United States.
                            When your data is transferred to jurisdictions that may not have
                            equivalent data protection laws, we take appropriate safeguards
                            including:
                        </p>
                        <ul className="text-muted-foreground mt-2 ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            ...
                            <li>
                                Contractual commitments from sub-processors to maintain appropriate
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground mb-3 leading-relaxed">
                            We use a limited set of cookies strictly necessary for the operation of
                            the Service:
                        </p>
                        <div className="border-border/60 rounded-xl border">
                            <table className="w-full text-sm">
                        ...
                        <p className="text-muted-foreground mt-3 leading-relaxed">
                            ...
                            analytics services that track you across websites. We do not participate
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground mb-3 leading-relaxed">
                            ...
                            to provide our services. Specific retention periods:
                        </p>
                        <div className="border-border/60 rounded-xl border">
                            <table className="w-full text-sm">
                                <thead>
                                ...
                                <tbody className="divide-border/40 divide-y">
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            Retained for persistent agent memory while your account
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            Retained until you delete them or request account
                                            deletion
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td className="text-muted-foreground px-5 py-3">
                                            Retained for 12 months for security and compliance
                                            purposes
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <p className="text-muted-foreground mt-3 leading-relaxed">
                            ...
                            completion. Some data may be retained longer if required by law or for
                    ...
                    <section>
                        ...
                        <ul className="text-muted-foreground ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            ...
                            <li>
                                ...
                                (e.g., disconnecting an integration)
                            </li>
                            <li>
                                <strong className="text-foreground">Disconnect Integrations</strong>{" "}
                                — Disconnect any third-party integration at any time from your
                                dashboard, which immediately deletes stored credentials and ceases
                                access
                            </li>
                            <li>
                        ...
                        <p className="text-muted-foreground mt-3 leading-relaxed">
                            ...
                            . We will respond to your request within 30 days (or sooner as required
                            by applicable law). We will not discriminate against you for exercising
                            your privacy rights.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground mb-3 leading-relaxed">
                            ...
                            (CCPA) and California Privacy Rights Act (CPRA) provide you with
                            additional rights:
                        </p>
                        <ul className="text-muted-foreground ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            <li>
                                ...
                                purpose, and the categories of third parties with whom we share it
                            </li>
                            <li>
                                <strong className="text-foreground">Right to Delete</strong> — You
                                can request deletion of personal information we have collected from
                                you
                            </li>
                            <li>
                                <strong className="text-foreground">
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            therefore does not respond to Do Not Track (DNT) signals. We do not use
                            third-party tracking cookies or participate in cross-site tracking.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            children under 18 (or under 16 in the EEA). If we learn that we have
                            collected data from a child under the applicable age threshold, we will
                            delete it promptly. If you believe we have inadvertently collected such
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            ...
                            of material changes by: (a) posting the updated policy on this page with
                            a new &quot;Last updated&quot; date; and (b) for significant changes,
                            ...
                            periodically. Continued use of the Service after the effective date of
                    ...
                    <section>
                        ...
                        <p className="text-muted-foreground leading-relaxed">
                            If you are unsatisfied with our response to a privacy concern, you have
                            the right to lodge a complaint with the relevant data protection
                            authority in your jurisdiction:
                        </p>
                        <ul className="text-muted-foreground mt-2 ml-5 list-disc space-y-2 text-sm leading-relaxed">
                            <li>
                                <strong className="text-foreground">Australia:</strong> Office of
