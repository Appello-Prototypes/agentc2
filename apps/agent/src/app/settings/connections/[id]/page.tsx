...
export default function ConnectionDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        ...
        fetchAgents();
        fetchMessages();
    }, [id, fetchConnection, fetchMessages]);
    ...
    return (
        <div className="space-y-6">
                ...
                <CardContent className="space-y-3">
                    {agents.length === 0 ? (
                        ...
                        <>
                            ...
                            <Button size="sm" onClick={saveExposures} disabled={savingExposures}>
            ...
            <Card>
                ...
                <CardContent>
                    {connection.partnerExposures.length === 0 ? (
                        <p className="text-muted-foreground text-sm">No agents shared yet.</p>
                    ) : (
                    ...
                    <CollapsibleContent>
                        <CardContent className="space-y-4 pt-0">
                            ...
                            <div>
                                ...
                                <Select value={connection.governance.dataClassification} disabled>
            ...
            {/* Health Dashboard */}
            {connection.status === "active" && <ConnectionHealthDashboard connectionId={id} />}
