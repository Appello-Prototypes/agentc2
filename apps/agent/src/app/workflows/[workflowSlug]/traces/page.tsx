    ...
    const loadRun = useCallback(
        async (runId: string, silent = false) => {
            try {
                ...
                console.error("Failed to load workflow trace:", error);
                setSelectedRun(null);
            } finally {
                if (!silent) {
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                        Step-by-step workflow execution traces with inputs and outputs.
                    </p>
                </div>
            ...
            <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Inspect each step and its output.</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        {detailLoading ? (
