...
| **Zoom AI Companion 3.0** | Agentic AI that takes actions, not just notes — moves beyond transcription to execution      | The vision: meetings that automatically _do things_ as a result                  |
...
📋 _Meeting Debrief: [Title]_
🕐 [Time] | 👥 [Attendees] | 🏢 [Company] | ⏱️ [Duration]

_Sentiment_: [emoji] [assessment]
...
_Note: `11-23 UTC` = `7am-7pm ET` (during EDT). Extended to 7pm to catch end-of-day meetings._
...
_Note: P1-P4 are shared with the pre-meeting-prep agent. If already connected, skip._
