...
| File                                     | Action                            |
| ---------------------------------------- | --------------------------------- |
| `packages/mastra/src/agents/resolver.ts` | Add binding context interpolation |
...
| `packages/mastra/src/agents/resolver.ts`       | Support namespace override   |
...
| File                                          | Action                     |
| --------------------------------------------- | -------------------------- |
| `packages/mastra/src/agents/resolver.ts`      | Pass RAG scope filter      |
