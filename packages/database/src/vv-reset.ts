...
const tables = [
    ...
    "network_run_step",
    "email_message",
    "bim_element_property",
    "bim_geometry_summary",
    "agent_trace",
    "email_thread",
    "bim_element",
    "agent_run",
    ...
    "cost_event",
    "agent_cost_daily",
    "agent_model_cost_daily",
    "cost_recommendation",
    "guardrail_policy",
    "guardrail_event",
    "agent_stats_daily",
    "agent_metric_daily",
    "agent_tool_metric_daily",
    "agent_model_metric_daily",
    "agent_quality_metric_daily",
    "agent_feedback_aggregate_daily",
    "agent_version_stats",
    "evaluation_theme",
    "insight",
    "trigger_event",
    ...
    "simulation_session",
    "workflow_version",
    "workflow_metric_daily",
    "network_primitive",
    "network_version",
    "network_metric_daily",
    "deployment",
    "bim_takeoff",
    "bim_clash",
    "bim_diff_summary",
...
async function main() {
    ...
    const checks = [
        ...
        ["Connections", "integration_connection"],
        ["Runs", "agent_run"],
        ["Orgs (kept)", "organization"],
        ["Users (kept)", `"user"`],
