...
const ORG_SCOPED_TOOL_IDS = new Set([
    ...
    "community-my-stats",
    // Sidekick
    "sidekick-list-agents",
    "sidekick-list-automations",
    "sidekick-create-schedule",
    "sidekick-edit-schedule",
    "sidekick-toggle-schedule",
    "sidekick-delete-schedule",
    "sidekick-describe-schedule",
    // Workflow CRUD+ops
    "workflow-create",
    "workflow-read",
    "workflow-update",
