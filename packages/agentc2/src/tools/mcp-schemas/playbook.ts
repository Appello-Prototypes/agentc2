...
export const playbookToolRoutes: McpToolRoute[] = [
    ...
    { kind: "registry", name: "playbook-list-installed" },
    { kind: "registry", name: "playbook-deploy" },
    { kind: "registry", name: "playbook-list-mine" },
    { kind: "registry", name: "playbook-get-full" },
    { kind: "registry", name: "playbook-update-metadata" },
    { kind: "registry", name: "playbook-get-boot-document" },
    { kind: "registry", name: "playbook-set-boot-document" },
    { kind: "registry", name: "playbook-add-boot-task" },
    { kind: "registry", name: "playbook-list-boot-tasks" },
    { kind: "registry", name: "playbook-update-boot-task" },
    { kind: "registry", name: "playbook-remove-boot-task" },
    { kind: "registry", name: "playbook-package" },
    { kind: "registry", name: "playbook-submit-review" },
    { kind: "registry", name: "playbook-set-auto-boot" }
];
