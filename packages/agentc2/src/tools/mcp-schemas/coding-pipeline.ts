...
export const codingPipelineToolRoutes: McpToolRoute[] = [
    { kind: "registry", name: "cursor-launch-agent", injectOrg: true },
    { kind: "registry", name: "cursor-get-status", injectOrg: true },
    { kind: "registry", name: "cursor-add-followup", injectOrg: true },
    { kind: "registry", name: "cursor-get-conversation", injectOrg: true },
    { kind: "registry", name: "cursor-poll-until-done", injectOrg: true },
    { kind: "registry", name: "claude-launch-agent", injectOrg: true },
    { kind: "registry", name: "claude-get-status", injectOrg: true },
    { kind: "registry", name: "claude-add-followup", injectOrg: true },
    { kind: "registry", name: "claude-get-conversation", injectOrg: true },
    { kind: "registry", name: "claude-poll-until-done", injectOrg: true },
