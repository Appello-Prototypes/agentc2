...
async function resetDatabase() {
    ...
    console.log(
        "This will delete ALL data except Organization, Workspace, User, Membership, and auth tables.\n"
    );
    ...
    const l1 = await Promise.all([
        prisma.agentTraceStep
            .deleteMany()
            .then((r) => ({ table: "AgentTraceStep", count: r.count })),
        prisma.agentToolCall.deleteMany().then((r) => ({ table: "AgentToolCall", count: r.count })),
        prisma.workflowRunStep
            .deleteMany()
            .then((r) => ({ table: "WorkflowRunStep", count: r.count })),
        prisma.networkRunStep
            .deleteMany()
            .then((r) => ({ table: "NetworkRunStep", count: r.count })),
    ...
    const l3 = await Promise.all([
        ...
        prisma.agentEvaluation
            .deleteMany()
            .then((r) => ({ table: "AgentEvaluation", count: r.count })),
        ...
        prisma.agentConversation
            .deleteMany()
            .then((r) => ({ table: "AgentConversation", count: r.count })),
        ...
        prisma.agentCostDaily
            .deleteMany()
            .then((r) => ({ table: "AgentCostDaily", count: r.count })),
        prisma.agentModelCostDaily
            .deleteMany()
            .then((r) => ({ table: "AgentModelCostDaily", count: r.count })),
        prisma.costRecommendation
            .deleteMany()
            .then((r) => ({ table: "CostRecommendation", count: r.count })),
        prisma.guardrailPolicy
            .deleteMany()
            .then((r) => ({ table: "GuardrailPolicy", count: r.count })),
        prisma.guardrailEvent
            .deleteMany()
            .then((r) => ({ table: "GuardrailEvent", count: r.count })),
        prisma.agentStatsDaily
            .deleteMany()
            .then((r) => ({ table: "AgentStatsDaily", count: r.count })),
        prisma.agentMetricDaily
            .deleteMany()
            .then((r) => ({ table: "AgentMetricDaily", count: r.count })),
        prisma.agentToolMetricDaily
            .deleteMany()
            .then((r) => ({ table: "AgentToolMetricDaily", count: r.count })),
        prisma.agentModelMetricDaily
            .deleteMany()
            .then((r) => ({ table: "AgentModelMetricDaily", count: r.count })),
        prisma.agentQualityMetricDaily
            .deleteMany()
            .then((r) => ({ table: "AgentQualityMetricDaily", count: r.count })),
        prisma.agentFeedbackAggregateDaily
            .deleteMany()
            .then((r) => ({ table: "AgentFeedbackAggregateDaily", count: r.count })),
        prisma.agentVersionStats
            .deleteMany()
            .then((r) => ({ table: "AgentVersionStats", count: r.count })),
        prisma.evaluationTheme
            .deleteMany()
            .then((r) => ({ table: "EvaluationTheme", count: r.count })),
        ...
        prisma.gmailIntegration
            .deleteMany()
            .then((r) => ({ table: "GmailIntegration", count: r.count }))
    ]);
    for (const r of l3) console.log(`  ${r.table}: ${r.count} deleted`);

    // Level 3b: Learning system
    const l3b = await Promise.all([
        prisma.learningApproval
            .deleteMany()
            .then((r) => ({ table: "LearningApproval", count: r.count })),
        prisma.learningExperiment
            .deleteMany()
            .then((r) => ({ table: "LearningExperiment", count: r.count })),
        prisma.learningProposal
            .deleteMany()
            .then((r) => ({ table: "LearningProposal", count: r.count })),
        prisma.learningSignal
            .deleteMany()
            .then((r) => ({ table: "LearningSignal", count: r.count })),
        prisma.learningDataset
            .deleteMany()
            .then((r) => ({ table: "LearningDataset", count: r.count })),
        prisma.learningSession
            .deleteMany()
            .then((r) => ({ table: "LearningSession", count: r.count })),
        prisma.learningPolicy
            .deleteMany()
            .then((r) => ({ table: "LearningPolicy", count: r.count })),
        prisma.learningMetricDaily
            .deleteMany()
            .then((r) => ({ table: "LearningMetricDaily", count: r.count })),
        prisma.simulationSession
            .deleteMany()
            .then((r) => ({ table: "SimulationSession", count: r.count }))
    ]);
    ...
    const l3c = await Promise.all([
        prisma.workflowVersion
            .deleteMany()
            .then((r) => ({ table: "WorkflowVersion", count: r.count })),
        prisma.workflowMetricDaily
            .deleteMany()
            .then((r) => ({ table: "WorkflowMetricDaily", count: r.count })),
        prisma.networkPrimitive
            .deleteMany()
            .then((r) => ({ table: "NetworkPrimitive", count: r.count })),
        prisma.networkVersion
            .deleteMany()
            .then((r) => ({ table: "NetworkVersion", count: r.count })),
        prisma.networkMetricDaily
            .deleteMany()
            .then((r) => ({ table: "NetworkMetricDaily", count: r.count })),
    ...
    const l5 = await Promise.all([
        ...
        prisma.meetingTranscript
            .deleteMany()
            .then((r) => ({ table: "MeetingTranscript", count: r.count })),
        prisma.actionItem.deleteMany().then((r) => ({ table: "ActionItem", count: r.count })),
        prisma.approvalRequest
            .deleteMany()
            .then((r) => ({ table: "ApprovalRequest", count: r.count })),
        prisma.identityMapping
            .deleteMany()
            .then((r) => ({ table: "IdentityMapping", count: r.count })),
        prisma.crmAuditLog.deleteMany().then((r) => ({ table: "CrmAuditLog", count: r.count })),
        prisma.integrationConnection
            .deleteMany()
            .then((r) => ({ table: "IntegrationConnection", count: r.count })),
        prisma.toolCredential
            .deleteMany()
            .then((r) => ({ table: "ToolCredential", count: r.count })),
        prisma.organizationInvite
            .deleteMany()
            .then((r) => ({ table: "OrganizationInvite", count: r.count })),
        prisma.organizationDomain
            .deleteMany()
            .then((r) => ({ table: "OrganizationDomain", count: r.count }))
    ]);
    ...
    const l6 = await Promise.all([
        prisma.channelSession
            .deleteMany()
            .then((r) => ({ table: "ChannelSession", count: r.count })),
        prisma.channelCredentials
            .deleteMany()
            .then((r) => ({ table: "ChannelCredentials", count: r.count })),
        prisma.voiceCallLog.deleteMany().then((r) => ({ table: "VoiceCallLog", count: r.count })),
        prisma.voiceAgentTrace
            .deleteMany()
            .then((r) => ({ table: "VoiceAgentTrace", count: r.count })),
